...
public class BaseClass {
	...
	private static EdgeOptions setedgeCapbilities() {
		EdgeOptions option1=new EdgeOptions();
		option1.addArguments("start-maximized");
		Map<String,Object> prefs=new HashMap<String,Object>();
		prefs.put("download.default_directory", "/directory/path");
		option1.setExperimentalOption("prefs", prefs);
		option1.setExperimentalOption("excludeSwitches", Arrays.asList("disable-popup-blocking"));
		return option1;	
